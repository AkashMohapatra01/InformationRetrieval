  ...
  void computeFeatureUtility(){
    ...
    for (int termID = 0; termID < numberOfTerms; termID++){
      ...
      if (N11 == 0 || N01 == 0 || N10 == 0 || N00 == 0) Chi2[termID] = 0;
    	  ...
    	  Chi2[termID] = N*(((N11*N00)*(N10*N01))*((N11*N00)*(N10*N01)))/(Nx1*N1x*N0x*Nx0);
      }						
   }
  } 
