...
public class IR18{
 ...
 void showSubtree(int index, int depth){  // print titles with indentation
    // Your code to insert depth many spaces before title
	 int j1 = depth; for (; j1 >= 0; j1--)
	 {
				System.out.print(" ");
	 }
 ...
 public static void main(String[] args){
  IR18 ir18 = new IR18();
  ir18.readInvertedIndex(args[0]);
  ir18.readTitles(args[1]);
