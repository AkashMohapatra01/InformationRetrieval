...
// binary search
 ...
 public static void main(String[] args){
   ...
   ir25.readNet("C:\\Users\\Akash\\workspace\\InfoRet6\\data\\adNet.txt"); // "isrNet.txt is the output from java IR25A isrInvertedTf.txt
   String[] arr = new String[1];
   arr[0] = "aberrant";
   ir25.powerMethod(arr); // args is the query
